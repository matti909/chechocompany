        ...
        >
          <div className="absolute inset-0">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(5,10,5,1) 0%, rgba(5,10,5,0.7) 50%, rgba(5,10,5,0.2) 100%)",
              }}
            />
            <div
              className="absolute inset-0"
              style={{
                background:
                  "linear-gradient(to right, rgba(5,10,5,0.6) 0%, transparent 70%)",
              }}
            />
          </div>

          <div
            className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col justify-end h-full"
            style={{
              minHeight: "52vh",
              paddingBottom: "4rem",
              paddingTop: "8rem",
          ...
          >
            <div ref={heroRef} className="max-w-2xl">
              ...
              <p className="gc-mono text-[#7a9a7a] text-sm leading-relaxed max-w-md">
                Semillas REGULARES ARGENTINAS desarrolladas con precisión
                científica para el cultivador exigente.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between gap-4 py-3">
              ...
              <span className="gc-mono text-[10px] text-[#3a5a3a] tracking-widest">
                {filtered.length}{" "}
                {filtered.length === 1 ? "variedad" : "variedades"}
              </span>
            </div>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        className="gc-mono text-[10px] mb-3 truncate"
                        style={{ color: accent }}
                      >
                        {genetic.genetics}
                      </p>
