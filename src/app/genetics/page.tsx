...
const geneticsData = [
  ...
  },
  {
    ...
    production: '500g/m² - 900g/planta',
    awards: ['1° Premio Outdoor Copa MF 2013', '2° Indoor Copa Txapelketa 2013', 'Especial para clonar'],
    color: 'blue',
    price: '$48.000',
    difficulty: 'Fácil',
    environment: 'Interior/Exterior',
  ...
  },
  {
    id: 'amnesia-haze',
    name: 'AMNESIA HAZE',
    subtitle: 'Clásica Sativa',
    genotype: '80% Sativa - 20% Indica',
    thc: '19-22%',
    cbd: '0.5%',
    flowering: '10-12 semanas',
    flavor: 'Cítrico, limón, tierra',
    production: '450-550g/m² - 700-900g/planta',
    medicalUse: ['Antidepresivo', 'Estimula creatividad', 'Energizante'],
    color: 'orange',
    price: '$50.000',
    difficulty: 'Avanzado',
    environment: 'Interior/Exterior',
  ...
  },
  {
    ...
    subtitle: 'Pure Indica',
    genotype: '95% Indica - 5% Sativa',
    thc: '16-18%',
    cbd: '1.5%',
    flowering: '7-8 semanas',
    flavor: 'Dulce, pino, tierra',
    production: '400-500g/m² - 500-700g/planta',
    medicalUse: ['Relajante muscular', 'Anti-insomnio', 'Alivio del estrés'],
    color: 'purple',
    price: '$42.000',
    difficulty: 'Fácil',
    environment: 'Interior/Exterior',
  ...
  },
  {
    id: 'white-widow',
    name: 'WHITE WIDOW',
    subtitle: 'Balanceada Premium',
    genotype: '50% Indica - 50% Sativa',
    thc: '20-25%',
    cbd: '0.9%',
    flowering: '8-9 semanas',
    flavor: 'Pino, madera, especias',
    production: '450-600g/m² - 600-800g/planta',
    medicalUse: ['Alivio del dolor', 'Anti-náusea', 'Estimula apetito'],
    color: 'cyan',
    price: '$55.000',
    difficulty: 'Intermedio',
    environment: 'Interior/Exterior',
